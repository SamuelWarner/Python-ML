...
class Maze:
    def __init__(self, network_layers, activation_function):
        ...
        if type(network_layers) != list:
            raise TypeError("SigNet.__init__(self, network_layers) expected list for network_layers, "
        ...
        self.learning_constant = 0.1         # learning constant, higher value = more aggressive weight adjustments
